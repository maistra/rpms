...
# Taken from https://github.com/maistra/envoy/blob/maistra-1.2/bazel/repository_locations.bzl#L283
Source0: https://storage.googleapis.com/envoyproxy-wee8/wee8-%{version}.tar.gz
Patch0:  wee8.patch
